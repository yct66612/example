...
打开 `http://127.0.0.1:8000`。页面提供新建任务、重置演示任务、认领、启动、查看参数和五次并发完成上报。

点击“新建任务”可以填写任务组、任务名称、L1 基础参数、L2 组级覆盖和多个 L3 步骤参数。点击“重置演示任务”会删除旧演示任务并重新创建一条 `pending` 任务，不会删除其他自定义任务。
