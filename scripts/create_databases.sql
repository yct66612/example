...
CREATE USER IF NOT EXISTS 'scheduler_app'@'127.0.0.1' IDENTIFIED BY 'change-me';
...
GRANT ALL PRIVILEGES ON task_scheduler.* TO 'scheduler_app'@'127.0.0.1';
GRANT ALL PRIVILEGES ON task_scheduler_test.* TO 'scheduler_app'@'127.0.0.1';
FLUSH PRIVILEGES;
